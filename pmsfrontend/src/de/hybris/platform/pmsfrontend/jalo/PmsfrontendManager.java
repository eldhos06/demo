 ...
 *  
 */
package de.hybris.platform.pmsfrontend.jalo;
...
import de.hybris.platform.pmsfrontend.constants.PmsfrontendConstants;



/**
 * This is the extension manager of the Pmsfrontend extension.
 */
public class PmsfrontendManager extends GeneratedPmsfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PmsfrontendManager.class.getName());
	 ...
	 */
	public static PmsfrontendManager getInstance()
	{
		return (PmsfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PmsfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PmsfrontendManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PmsfrontendManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PmsfrontendManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PmsfrontendManager called, current tenant: " + getTenant().getTenantID());
		}
	}
