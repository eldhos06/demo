...
/**
 * This is the extension manager of the Pms extension.
 */
public class PmsManager extends GeneratedPmsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(PmsManager.class.getName());
	 ...
	 */
	public static PmsManager getInstance()
	{
		return (PmsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				PmsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public PmsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of PmsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PmsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PmsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
